...
?>
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Podra Ingresar nuevos registros a la tabla Tipo Vivienda</p>
          ...
          <!-- Content Row -->
           <div class="card-body">
              <div class="form-responsive">
                ...
                <hr>
                <form action="wjbt_guardarTipoVivienda.php" method="post">

                    <h1>Agregar Tipo Vivienda</h1>
                  <div class="row" style="margin-top: 15px;">
                      ...
                      <div class="form-group col-md-6">
                          <label for="tipo"><b>Nombre</b></label>
                          <input type="text" name="tipo" class="form-control" id="tipo" placeholder="Ingrese el nuevo tipo de Nivel academico de los padres" autofocus required>
                      </div>
