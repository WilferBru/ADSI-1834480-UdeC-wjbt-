...
?>
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Podra Ingresar nuevos registros a la tabla Estado Civil</p>
          ...
          <!-- Content Row -->
           <div class="card-body">
              <div class="form-responsive">
                ...
                <hr>
                <form action="wjbt_guardarEstadoCivil.php" method="post">
                  ...
                  <div class="row" style="margin-top: 15px;">
                      ...
                      <div class="form-group col-md-6">
                          <label for="estadocivil_wjbt"><b>Nombre</b></label>
                          <input type="text" name="estado" class="form-control" id="estado" placeholder="Ingrese el nuevo tipo de Estado Civil"  required>
                      </div>
