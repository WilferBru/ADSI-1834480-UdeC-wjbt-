...
<?php 
 ...
 try {
    ...
    $sql = "SELECT * FROM genero_wjbt WHERE id_wjbt = ? ";
          ...
          <!-- Content Row -->
           <div class="card-body">
              <div class="form-responsive">
                ...
                <hr>
                <form action="wjbt_actualizadoGenero.php" method="get">

                  <h1>Guardar Genero</h1>
                  <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" value="<?=$row->genero_wjbt?>" name="genero" class="form-control" placeholder="Tipo de genereo" id="genero" required>
                        </div>
