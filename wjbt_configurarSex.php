...
<?php 
  ...
  try {
    ...
    $sql0 = "SELECT sesion_wjbt.id_wjbt, genero_wjbt.genero_wjbt FROM sesion_wjbt INNER JOIN genero_wjbt ON sesion_wjbt.id_genero_wjbt = genero_wjbt.id_wjbt WHERE identificacion_wjbt = ?";
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div class="form-responsive">
        <form action="wjbt_cambioSex.php" method="post">
