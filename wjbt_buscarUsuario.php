...
<?php 
 ...
 try {
    ...
    $sql = "SELECT sesion_wjbt.id_wjbt, sesion_wjbt.identificacion_wjbt, sesion_wjbt.nombre_wjbt, sesion_wjbt.usuario_wjbt, sesion_wjbt.password_wjbt, genero_wjbt.genero_wjbt FROM sesion_wjbt INNER JOIN  genero_wjbt ON sesion_wjbt.id_genero_wjbt = genero_wjbt.id_wjbt WHERE sesion_wjbt.id_wjbt = '$palabra' OR sesion_wjbt.identificacion_wjbt = '$palabra' OR sesion_wjbt.nombre_wjbt LIKE '%$palabra%' OR sesion_wjbt.usuario_wjbt LIKE '%$palabra' OR genero_wjbt.genero_wjbt LIKE '%$palabra%'";
