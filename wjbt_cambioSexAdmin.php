...
<?php
    ...
    include_once('wjbt_contenido.php');
      echo '<div class="card-body">
              ...
              <div class="dataTables_length" id="dataTable_length"><a href="wjbt_configurarSexAdmin.php" class="btn btn-success b">Volver</a></div>
              ';
    include_once('wjbt_footer.php');
      ...
      try {
        ...
        if ($stm->rowCount() > 0) {
              ...
              $sql2 = "UPDATE sesionAdmin_wjbt SET id_genero_wjbt = ? WHERE id_wjbt = ? ";
          ...
          header('location:wjbt_configurarSexAdmin.php?err=$msg');
        }
