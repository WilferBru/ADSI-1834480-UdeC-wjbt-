...
?>
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Podra Ingresar nuevos registros a la tabla Localidad</p>
          ...
          <!-- Content Row -->
           <div class="card-body">
              <div class="form-responsive">
                ...
                <hr>
                <form action="wjbt_guardarLocalidad.php" method="post">

                    <h1>Agregar Tipo De Localidad</h1>
                  <div class="row" style="margin-top: 15px;">
                      ...
                      <div class="form-group col-md-6">
                          <label for="zona"><b>Nombre</b></label>
                          <input type="text" name="zona" class="form-control" id="zona" placeholder="Ingrese el nuevo tipo de Localidad"  required>
                      </div>
