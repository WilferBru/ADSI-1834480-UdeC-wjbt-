...
<?php 
 ...
 try {
   ...
   include_once('wjbt_conexion.php');
    ...
    $sql = "SELECT * FROM tipovivienda_wjbt WHERE id_wjbt = ? ";
          ...
          <!-- Content Row -->
           <div class="card-body">
              <div class="form-responsive">
                ...
                <hr>
                <form action="wjbt_actualizadoTipoVivienda.php" method="get">

                  <h1>Guardar Tipo De Vivienda</h1>
                  <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="tipo"><strong>Tipo Vivienda</strong></label>
                            <input type="text" value="<?=$row->tipo_wjbt?>" name="tipo" class="form-control" placeholder="Tipo de Vivienda" id="tipo" required>
                        </div>
