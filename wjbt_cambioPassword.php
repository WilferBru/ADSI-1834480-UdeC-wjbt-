...
<?php
    ...
    include_once('wjbt_contenidoIndex.php');
      echo '<div class="card-body">
              ...
              <div class="dataTables_length" id="dataTable_length"><a href="wjbt_configurarPassword.php" class="btn btn-success b">Volver</a></div>
              ';
       ...
       include_once('wjbt_conexion.php');
        ...
        if ($stm->rowCount() > 0) {
            ...
            if ($claveE1==$claveE2) {
              ...
              $sql2 = "UPDATE sesion_wjbt SET password_wjbt = ? WHERE id_wjbt = ? ";
              ...
              header('location:wjbt_configurarPassword.php?ar=$msg');

            }
          
        } else {
          $ma = 'Su contraseña Antigua no es correcta';
          header('location:wjbt_configurarPassword.php?err=$ma');
        }
