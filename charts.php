...
var myBarChart = new Chart(ctx, {
  ...
  data: {
    labels: [ <?php 
            ...
            $sql = "SELECT zona_wjbt.zona_wjbt, COUNT(*) AS Cantidad FROM encuesta_wjbt INNER JOIN zona_wjbt ON encuesta_wjbt.id_zona_wjbt = zona_wjbt.id_wjbt GROUP BY encuesta_wjbt.id_zona_wjbt";
...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    labels: [ <?php 
            ...
            $sql20 = "SELECT genero_wjbt.genero_wjbt, COUNT(*) AS Cantidad FROM encuesta_wjbt INNER JOIN genero_wjbt ON encuesta_wjbt.id_genero_wjbt = genero_wjbt.id_wjbt GROUP BY encuesta_wjbt.id_genero_wjbt";
...
var myPieChart = new Chart(ctx, {
  ...
  data: {
    labels: [ <?php 
            ...
            $sql2 = "SELECT nivelacademicopadres_wjbt.nivel_wjbt, COUNT(*) AS Cantidad FROM encuesta_wjbt INNER JOIN nivelacademicopadres_wjbt ON encuesta_wjbt.id_nivelacademicopadres_wjbt = nivelacademicopadres_wjbt.id_wjbt GROUP BY encuesta_wjbt.id_nivelacademicopadres_wjbt";
