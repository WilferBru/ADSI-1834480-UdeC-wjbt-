...
?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="wjbt_encuesta.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Ver Encuesta</a>
          </div>
          <p>A su Izquierda tendra opciones para su solicitudes y para realizar la encuesta sí no la a echo, si ya la hizo podra vizualizarla y editar algo de su encuesta que le paresca pertinente.</p>
           <?php 
                  if ($msg != null) { ?>
                    <div class="alert alert-primary container" role="alert">
                      <?='Su encuesta a sido enviada con exito, si Cree que envio un dato erroneo o incorrecto, verifique y podra editar aquel dato que cree que se equiboco, mucas gracias. <a href="wjbt_encuesta.php" >Ver encuesta</a> '?>
                    </div><?php
                  }
            ?>
