...
<?php 
 ...
 try {
    ...
    $sql = "SELECT estudiantes_wjbt.id_wjbt, estudiantes_wjbt.apellido_wjbt, estudiantes_wjbt.nombre_wjbt, estudiantes_wjbt.programaFormacion_wjbt, genero_wjbt.genero_wjbt FROM estudiantes_wjbt INNER JOIN genero_wjbt ON estudiantes_wjbt.id_genero_wjbt = genero_wjbt.id_wjbt WHERE estudiantes_wjbt.id_wjbt = '$palabra' OR estudiantes_wjbt.apellido_wjbt LIKE '%$palabra%' OR estudiantes_wjbt.nombre_wjbt LIKE '%$palabra%' OR estudiantes_wjbt.programaFormacion_wjbt  LIKE '%$palabra%' OR genero_wjbt.genero_wjbt LIKE '%$palabra%'";
...
?>
        ...
        <div class="container-fluid">
          ...
          <div class="dataTables_length" id="dataTable_length"><a href="wjbt_estudiantes.php" class="btn btn-primary b">Volver</a></div><br>
            <?php 
                  if ($msg != null) { ?>
