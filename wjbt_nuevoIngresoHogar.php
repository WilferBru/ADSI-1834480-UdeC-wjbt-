...
?>
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Podra Ingresar nuevos registros a la tabla Ingreso del Hogar</p>
          ...
          <!-- Content Row -->
           <div class="card-body">
              <div class="form-responsive">
                ...
                <hr>
                <form action="wjbt_guardarIngresoHogar.php" method="post">

                    <h1>Agregar Tipo De Ingreso Economico</h1>
                  <div class="row" style="margin-top: 15px;">
                      ...
                      <div class="form-group col-md-6">
                          <label for="Ingreso"><b>Nombre</b></label>
                          <input type="text" name="ingreso" class="form-control" id="Ingreso" placeholder="Ingrese el nuevo tipo de Ingreso Economico"  required>
                      </div>
